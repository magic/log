...
export default [
  ...
  {
    fn: () => stringify('test', 'test2'),
    expect: 'test test2',
    info: 'stringify concatenates two strings',
  },
  {
  ...
  {
    fn: () => stringify(undefined, 'test2'),
    expect: 'undefined test2',
    info: 'stringify handles undefined',
  },
  { fn: () => stringify(null, 'test2'), expect: 'null test2', info: 'stringify handles null' },
  {
    fn: () => stringify(null, 'test2'),
    expect: 'null test2',
    info: 'stringify handles null again',
  },
  {
    fn: () => stringify(() => {}, 't'),
    expect: `${(() => {}).toString()} t`,
    info: 'stringify handles functions',
  },
